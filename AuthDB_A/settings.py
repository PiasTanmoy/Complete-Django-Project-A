"""
Django settings for AuthDB_A project.
...
SECRET_KEY = 'czn0qn54k0doa0(2sq7p1clx+=1@ee@5l=^d$-&q*aygfo69fg'
...
WSGI_APPLICATION = 'AuthDB_A.wsgi.application'
